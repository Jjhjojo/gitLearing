  ...
  <section id="city-list" class="city-list-container">
    <van-index-bar :sticky="false" :index-list="indexList">
      ...
      <section class="history-city-list">
        ...
        <div class="city-list city-list-inline clearfix">
          <div @click="pickCity({ name: '上海', id: '3' })" class="city-item">
            上海
          </div>
          <div
      ...
      <section>
        <template v-for="(cities, key) in cityData.cities">
          ...
          <div :key="key.id" class="city-list city-list-block clearfix">
            <div @click="pickCity(ci)" :key="ci.name" class="city-item"  v-for="ci in cities">
              {{ ci.name }}
            </div>
          </div>
        </template>
